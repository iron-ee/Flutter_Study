...
class _TourDetailPage extends State<TourDetailPage> {
  ...
  void initState() {
    ...
    _googleMapCamera = CameraPosition(      // 지도에서 관광지 위치를 표시하기 위한 변수
        ...
        double.parse(widget.tourData.mapx.toString())), zoom: 16,);

    MarkerId markerId = MarkerId(widget.tourData.hashCode.toString());
    marker = Marker(
      position: LatLng(double.parse(widget.tourData.mapy.toString()),
      double.parse(widget.tourData.mapx.toString())), flat: true, markerId: markerId);
                  ...
                  child: Column(
                    children: <Widget>[
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.fill,
                              image: widget.tourData.imagePath == 'nuill' ||
                                      widget.tourData.imagePath == null
                                    ? AssetImage('repo/images/map_location.png')
                                    : NetworkImage(widget.tourData.imagePath)
                            )
                          ),
                        ),
                      ),
                      Padding(
                          ...
                          child: Text(widget.tourData.address, style: TextStyle(fontSize: 20),),),
                      getGoogleMap(),
            ...
            delegate: _HeaderDelegate(
              ...
              child: Container(
                ...
                child: Center(
                  child: Column(
                    children: <Widget>[
                      Text('후기', style: TextStyle(fontSize: 30, color: Colors.white),),
